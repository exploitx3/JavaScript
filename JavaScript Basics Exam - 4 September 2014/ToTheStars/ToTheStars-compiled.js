function solve(inputArray) {
    ...
    for (var i = 0; i < moves; i++) {
        var checkInRangeOfFirstStar = normandyX >= firstStarX - 1 && normandyX <= firstStarX + 1 && normandyY >= firstStarY - 1 && normandyY <= firstStarY + 1;
        var checkInRangeOfSecondStar = normandyX >= secondStarX - 1 && normandyX <= secondStarX + 1 && normandyY >= secondStarY - 1 && normandyY <= secondStarY + 1;
        var checkInRangeOfThirdStar = normandyX >= thirdStarX - 1 && normandyX <= thirdStarX + 1 && normandyY >= thirdStarY - 1 && normandyY <= thirdStarY + 1;
...
var inputArray = ['Sirius 3 7', 'Alpha-Centauri 7 5', 'Gamma-Cygni 10 10', '8 1', '6'];

solve(inputArray);

//# sourceMappingURL=ToTheStars-compiled.js.map