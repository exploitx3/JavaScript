...
function rollandGarrosStatCalculator(inputArray) {
    ...
    function rollandGarrosArraySorter(playersArray) {
        var sortedArray = playersArray.sort((a, b) => {
            ...
            if (parseInt(a['matchesWon']) === parseInt(b['matchesWon']) && parseInt(a['setsWon']) !== parseInt(b['setsWon'])) {
                return b.setsWon - a.setsWon;
            }

            if (parseInt(a['matchesWon']) === parseInt(b['matchesWon']) && parseInt(a['setsWon']) === parseInt(b['setsWon']) && parseInt(a['gamesWon']) !== parseInt(b['gamesWon'])) {
...
//# sourceMappingURL=rollandGarros-compiled.js.map