function solve(inputArray) {
    ...
    for (var i = 0; i < inputArray.length; i++) {
        ...
        if (searchNameInObjectArray(resultsContainer[courseName], name) === -1) {
            ...
            resultsContainer[courseName][searchNameInObjectArray(resultsContainer[courseName], name)].result = resultsContainer[courseName][searchNameInObjectArray(resultsContainer[courseName], name)].result > points ? resultsContainer[courseName][searchNameInObjectArray(resultsContainer[courseName], name)].result : points;
        }
    }
...
var inputArray = ['Silvester - Java : 100', 'Johny - Java : 10', 'Silvester - Java: 110', 'Johny - Java : 20', 'Johny - Java : 30', 'Johny - Java : 40', 'Johny - Java : 120', 'Silvester - C#:200', 'Johny-C# :                      200', 'Johny - C# : 800', 'Johny - C#:200'];

solve(inputArray);

//# sourceMappingURL=StudentProtocol-compiled.js.map