function solve(inputArray) {
    ...
    for (var i = 1; i < inputArray.length - 1; i++) {
        ...
        for (var j = 1; j < minLength && j < upperLine.length - 1 && j < bottomLine.length - 1; j++) {
            ...
            xCheck = upperLine[j - 1].toLowerCase() === currentChar && upperLine[j + 1].toLowerCase() === currentChar && bottomLine[j - 1].toLowerCase() === currentChar && bottomLine[j + 1].toLowerCase() === currentChar;
...
var inputArray = ['abnbjs', 'xoBab', 'Abmbh', 'aabab', 'ababvvvv'];

var inputArray2 = ['puoUdai', 'miU', 'ausupirina', '8n8i8', 'm8o8a', '8l8o860', 'M8i8', '8e8!8?!'];
